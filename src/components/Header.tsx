...
const Header = () => {
  return <div  style={{backgroundColor:"rgba(255,255,255,0.1)",padding:"24px", width: "100%", flexDirection:"row",display:"flex",justifyContent:"space-between",alignItems:"center",position:"fixed",top:"0",left:"0",right:"0",zIndex:"1000" }}>
