...
const StyleCard = ({title,element}:StyleCardProps) => { 
    return <div style={{ width: "400px", height: "280px",alignItems:"center",justifySelf:'center',justifyContent:"center",display:"flex",flexDirection:"column",border:"1px solid lightGray" }}>
